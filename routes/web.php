...
Route::prefix('/')->middleware('auth')->group(function () {
    ...
    Route::get('akun/create', 'App\Http\Controllers\AkunController@create')->name('akun.create');
    Route::get('akun/edit', 'App\Http\Controllers\AkunController@edit')->name('akun.edit');
    Route::delete('akun/destroy', 'AkunController@destroys')->name('akun.destroy');
    ...
    Route::prefix('/akun')->middleware('auth')->group(function () {
        ...
        Route::post('/store', 'App\Http\Controllers\AkunController@store');
        Route::get('/edit/{id}', 'App\Http\Controllers\AkunController@edit');
        Route::put('/update/{id}', 'App\Http\Controllers\AkunController@update');
        Route::get('/show/{id}', 'App\Http\Controllers\AkunController@show');
        Route::delete('/destroy/{id}', 'App\Http\Controllers\AkunController@destroy');
    });
