...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex flex-col items-center justify-center w-full h-screen overflow-hidden bg-blue-100">
            ...
            <a href="{{ url('/dashboard') }}" class="inlinde-block flex items-center justyify-center gap-x-3 font-emdium text-base px-3 py-2.5 bg-blue-500 rounded-md text-white hover:bg-blue-700 hover:shadow-md transition-all duration-300 ease-in-out">
