...
<div class="section-header">
    <h1><i class="fa-solid fa-file-invoice-dollar"></i> Jurnal Umum</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a>Jurnal Umum</a> / <a href="{{ url('mataanggaran') }}">Mata Anggaran</a></div>
    </div>
</div>
