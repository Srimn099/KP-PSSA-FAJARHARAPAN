<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
    ...
    <li class="nav-item dropdown {{ Request::is(['tabungan*', 'kaskecil*', 'realisasianggaran*']) ? 'show active' : '' }}" data-dropdown-category="data_keuangan">
      ...
      <ul class="dropdown-menu" data-dropdown-category="data_keuangan">
        <li class="{{ Request::is('akun*') ? 'active' : '' }}">
          <a class="nav-link" href="{{ asset('akun') }}">Akun</a>
        </li>


        <li class="{{ Request::is('kaskecil*') ? 'active' : '' }}">
          <a class="nav-link" href="{{ asset('kaskecil') }}">Jurnal Umum</a>
        </li>
    ...
    <li class="nav-item dropdown {{ Request::is('data_siswa*') || Request::is('data_alumni*') ? 'active' : '' }}">
      <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
        <i class="fa fa-graduation-cap"></i> <span>Data Siswa</span>
      </a>
      <ul class="dropdown-menu">
        <li class="{{ Request::is('data_siswa*') ? 'active' : '' }}">
          <a class="nav-link" href="{{ asset('data_siswa') }}">Data Siswa</a>
        </li>
        <li class="{{ Request::is('data_alumni*') ? 'active' : '' }}">
          <a class="nav-link" href="{{ asset('data_alumni') }}">Data Alumni</a>
        </li>
      </ul>
    </li>
